    ...
    <section>
      <div className='mx-auto flex flex-col items-center justify-between gap-y-8 lg:flex-row lg:gap-x-20'>
        ...
        <div className='lg:basis-1/2'>
          <h1 className='mb-3 text-xl font-semibold capitalize text-gray-800 sm:mb-5 sm:text-2xl md:text-3xl lg:basis-1/2 lg:text-4xl'>
            Welcome to Yurexstore
          </h1>
          <div className='space-y-8'>
            <p>
              At Yurexstore, we are dedicated to delivering high-quality
              products that enrich the lives of our customers. With a focus on
              excellence, affordability, and innovation, we bring together a
              diverse range of offerings, from cutting-edge electronics to
              stylish apparel.
            </p>
            <p>
              ...
              whether it's through innovative design, unmatched craftsmanship,
              or thoughtful details.
            </p>
            <p>
